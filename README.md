...
One thing first: go to your LeetCode profile settings and make sure recent submissions are **public**. If that's off, the API returns nothing for you and your row will look empty even while you're grinding. Use `leetcode.cn` as your region if that's the site you're on — both regions are fully supported.
